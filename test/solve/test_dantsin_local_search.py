...
def test_is_satisfiable_dantsin_local_search_uf20_91(filename):
    """
    ...
    with open(file_path, 'r', encoding='utf-8') as file:
        ...
        # Solve instance
        result = is_satisfiable_dantsin_local_search(inst)
        assert result
...
def test_is_satisfiable_dantsin_local_search_small_unsat(filename):
    """
