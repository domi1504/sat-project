...
def test_is_satisfiable_gsat_with_walk_uf20_91(filename):
    """
    ...
    with open(file_path, 'r', encoding='utf-8') as file:
        ...
        # Solve instance
        result = is_satisfiable_gsat_with_walk(inst)
        assert result
...
def test_is_satisfiable_gsat_with_walk_small_unsat(filename):
    """
