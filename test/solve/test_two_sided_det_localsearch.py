...
def test_is_satisfiable_two_sided_det_localsearch_uf20_91(filename):
    """
    ...
    with open(file_path, 'r', encoding='utf-8') as file:
        ...
        # Solve instance
        result = is_satisfiable_two_sided_deterministic_local_search(inst)
        assert result
...
def test_is_satisfiable_two_sided_det_localsearch_small_unsat(filename):
    """
