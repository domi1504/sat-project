...
ALGOS = [
    lambda inst: is_satisfiable_dpll(inst, heuristic=dlis),
    lambda inst: is_satisfiable_dpll_cdcl_ncbt(inst, heuristic=dlis),
    lambda inst: is_satisfiable_monien_speckenmeyer(inst, False),
    lambda inst: is_satisfiable_monien_speckenmeyer(inst, True),
]
ALGO_NAMES = [
    "dpll",
    "dpll-cdcl",
