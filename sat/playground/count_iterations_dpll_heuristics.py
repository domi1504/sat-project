...
ALGOS = [
    lambda inst: is_satisfiable_dpll_cdcl_ncbt(inst, heuristic=dlis),
    lambda inst: is_satisfiable_dpll_cdcl_ncbt(inst, heuristic=dlcs),
    lambda inst: is_satisfiable_dpll_cdcl_ncbt(inst, heuristic=rdlcs),
    lambda inst: is_satisfiable_dpll_cdcl_ncbt(inst, heuristic=mom),
    lambda inst: is_satisfiable_dpll_cdcl_ncbt(inst, heuristic=jeroslaw_wang),
    lambda inst: is_satisfiable_dpll_cdcl_ncbt(inst, heuristic=jeroslaw_wang_two_sided),
]
ALGO_NAMES = [
    "dpll-cdcl-dlis",
    "dpll-cdcl-dlcs",
